...
<div id="main" class="gallery" align="center">
	...
	<div class="tab-container">
		<span class="stats-switch-views">
			<a href="/damsmanager/statsRdcpDownload.do?start=${model.start}&${switchView}">${switchViewTitle}</a>
		</span>
		<div class="tab-title">RDCP Downloads by Month ${viewTitle}</div>
		...
		<div class="export">
			<a href="/damsmanager/statsRdcpDownload.do?start=${model.start}&${model.unique}&export">

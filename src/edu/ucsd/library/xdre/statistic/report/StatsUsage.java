...
public abstract class StatsUsage {
	...
	public static final String RDCP_OBJECT_POPULARITY_QUERY = "SELECT * FROM (SELECT TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM') AS period, a.OBJECT_ID as object_id, SUM(a.NUM_VIEW) as num_view FROM WEB_STATS s, STATS_DLP_OBJECT_ACCESS a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND a.UNIT_ID='" + UNIT_CODE_RDCP + "' AND s.APP_NAME='pas' AND num_view>0 AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "') GROUP BY TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM'), a.OBJECT_ID ORDER BY num_view DESC) as result"; 
	public static final String RDCP_FILE_DOWNLOAD_POPULARITY_QUERY = "SELECT * FROM (SELECT TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM') AS period, a.OBJECT_ID as object_id, a.COMP_ID as comp_id, SUM(a.NUM_VIEW) as num_view FROM WEB_STATS s, STATS_FILE_DOWNLOAD a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND a.UNIT_ID='" + UNIT_CODE_RDCP + "' AND s.APP_NAME='pas'  AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "') GROUP BY TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM'), a.OBJECT_ID, a.COMP_ID ORDER BY num_view DESC) as result"; 
	public static final String RDCP_OBJECT_POPULARITY_UNIQUE_QUERY = "SELECT COUNT(*) as num_view, TO_CHAR(STAT_DATE, 'PERIOD_PARAM') AS period, object_id FROM (SELECT s.STAT_DATE as stat_date, a.CLIENT_IP as client_ip, a.OBJECT_ID as object_id FROM WEB_STATS s, STATS_DLP_OBJECT_ACCESS a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND a.UNIT_ID='" + UNIT_CODE_RDCP + "' AND s.APP_NAME='pas' AND a.NUM_VIEW>0 AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "')) as result GROUP BY period, object_id ORDER BY num_view DESC"; 
	public static final String RDCP_FILE_DOWNLOAD_POPULARITY_UNIQUE_QUERY = "SELECT COUNT(*) as num_view, TO_CHAR(STAT_DATE, 'PERIOD_PARAM') AS period, object_id, comp_id FROM (SELECT s.STAT_DATE as stat_date, a.CLIENT_IP as client_ip, a.OBJECT_ID as object_id, a.COMP_ID as comp_id FROM WEB_STATS s, STATS_FILE_DOWNLOAD a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND a.UNIT_ID='" + UNIT_CODE_RDCP + "' AND s.APP_NAME='pas' AND a.NUM_VIEW>0 AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "')) as result GROUP BY period, object_id, comp_id ORDER BY num_view DESC"; 
	public static final String COLLECTION_OBJECT_POPULARITY_QUERY = "SELECT * FROM (SELECT TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM') AS period, a.COL_ID as col_id, SUM(a.NUM_VIEW) as num_view FROM WEB_STATS s, STATS_DLP_OBJECT_ACCESS a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND s.APP_NAME='pas' AND num_view>0 AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "') GROUP BY TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM'), a.COL_ID ORDER BY num_view DESC) as result"; 
	public static final String COLLECTION_FILE_DOWNLOAD_POPULARITY_QUERY = "SELECT * FROM (SELECT TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM') AS period, a.COL_ID as col_id, SUM(a.NUM_VIEW) as num_view FROM WEB_STATS s, STATS_FILE_DOWNLOAD a WHERE s.ID=a.STAT_ID AND a.IS_PRIVATE=? AND s.APP_NAME='pas'  AND s.STAT_DATE>=to_date(?, '" + Statistics.DATE_FORMAT + "') AND s.STAT_DATE<=to_date(?, '" + Statistics.DATE_FORMAT + "') GROUP BY TO_CHAR(s.STAT_DATE, 'PERIOD_PARAM'), a.COL_ID ORDER BY num_view DESC) as result"; 

...
/**
 * BatchExportController - utility class to export data in batch.
 * @author lsitu
 *
 */
public class BatchExportController implements Controller {
    private static Logger log = Logger.getLogger(BatchExportController.class);
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
            ...
            return new ModelAndView("batchExport", "model", data);
    }
}
